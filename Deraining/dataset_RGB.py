...
class DataLoaderTrain(Dataset):
    def __init__(self, rgb_dir, img_options=None):
        ...
        if not os.path.exists(os.path.join(rgb_dir, 'input')):
            os.mkdir(os.path.join(rgb_dir, 'input'))
        
        if not os.path.exists(os.path.join(rgb_dir, 'target')):
            os.mkdir(os.path.join(rgb_dir, 'target'))
